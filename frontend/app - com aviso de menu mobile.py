...
def main():
    ...
    # ✅ Daqui pra baixo: usuário LOGADO (painel)

    # 🔔 Aviso só no mobile explicando o >>
    st.markdown("""
    <div class="menu-tip-mobile">
        👉 Toque no símbolo <b>&gt;&gt;</b> no canto esquerdo para abrir o <b>Menu de opções</b>.
    </div>
    ...
    # ... aqui continua o resto do seu código do painel (menu lateral, telas, etc.) ...
